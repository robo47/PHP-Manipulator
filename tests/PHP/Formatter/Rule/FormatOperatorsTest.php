...
{
    /**
     * @covers PHP_Formatter_Rule_FormatOperators::init
     */
    ...
    /**
     * @covers PHP_Formatter_Rule_FormatOperators::applyRuleToTokens
     * @covers PHP_Formatter_Rule_FormatOperators::<protected>
     * @dataProvider ruleProvider
     */
    public function testRule($options, $input, $expectedTokens)
    {
        $rule = new PHP_Formatter_Rule_FormatOperators($options);
