 ...
 */
class PHP_Formatter_TokenConstraint_IsOpeningCurlyBraceTest extends TestCase
{
     ...
     * @covers PHP_Formatter_TokenConstraint_IsOpeningCurlyBrace::evaluate
     */
    public function testEvaluate($token, $result)
    {
        $constraint = new PHP_Formatter_TokenConstraint_IsOpeningCurlyBrace();
