...
/**
 * @group TokenConstraint_EndsWithNewline
 */
class PHP_Manipulator_TokenConstraint_EndsWithNewlineTest extends TestCase
{
     ...
     * @covers PHP_Manipulator_TokenConstraint_EndsWithNewline::evaluate
     */
    public function testEvaluate($token, $result)
    {
        $constraint = new PHP_Manipulator_TokenConstraint_EndsWithNewline();
